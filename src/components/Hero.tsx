...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 pt-20 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative container mx-auto px-4 py-12 lg:py-16 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-8">
            {/* Top Badge */}
            <div className="inline-flex items-center gap-2 bg-amber-100 text-amber-900 px-4 py-2 rounded-full">
              <svg className="h-5 w-5 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              <span className="font-bold text-sm">4.9★ Rated • 500+ Reviews</span>
            </div>
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.1] text-gray-900">
                ...
                <span className="text-amber-600">₹11/km • Instant Cab Booking</span>
              </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href={`tel:${PHONE}`}
                className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-lg font-bold transition-all shadow-lg shadow-amber-500/30"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-bold transition-all"
              >
          ...
          <div className="lg:sticky lg:top-24">
            <div className="bg-white rounded-2xl shadow-2xl p-1">
              <div className="bg-gradient-to-br from-amber-500 to-orange-600 text-white text-center py-4 rounded-t-xl">
                <h3 className="text-xl font-bold">Book Your Cab Now</h3>
                <p className="text-sm text-amber-50 mt-1">Instant confirmation • Best rates</p>
              </div>
              <div className="p-6">
